...
public class Transaksi extends Order{
    ...
    public Transaksi(double totalHarga, int tanggalPesanan, String metodePembayaran, double Diskon, String ID_Order, int Jumlah_Makanan, String ID_Makanan, String Nama, int Jumlah, double Harga) {
